                ...
                <div className="row pt-4">
                        ...
                        <div className="w3-content">
                            ...
                            <div className="w3-row-padding w3-section">
                                <div className="w3-col s2">
                                    <img className="demo w3-opacity w3-hover-opacity-off check_border" src="./images/cloth_10.jpg"
                                        onClick="currentDiv(1)" />
                                </div>
                                <div className="w3-col s2">
                                    <img className="demo w3-opacity w3-hover-opacity-off check_border" src="./images/cloth_1.jpg"
                                        onClick="currentDiv(2)" />
                                </div>
                                <div className="w3-col s2">
                                    <img className="demo w3-opacity w3-hover-opacity-off check_border" src="./images/furni_1.jpg"
                                        onClick="currentDiv(3)" />
                                </div>
                                <div className="w3-col s2">
                                    <img className="demo w3-opacity w3-hover-opacity-off check_border" src="./images/furni_4.jpg"
                                        onClick="currentDiv(4)" />
                                </div>
                                <div className="w3-col s2">
                                    <img className="demo w3-opacity w3-hover-opacity-off check_border" src="./images/cloth_2.jpg"
                    ...
                    <div className="col-md-6">
                        <div className="product_details">
                            <h3 className="pro_title">Test Demo Product 10</h3>
                            ...
                            <div className="product_price_chng product_price_row d-flex justify-content-start">
                                <ins><i className="fa-solid fa-indian-rupee-sign"></i>90</ins> <del><i className="fa-solid fa-indian-rupee-sign"></i>100</del>
                                <span >10% off</span>
                            </div>
                            <div className="pro_p">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8 col-md-7">
                                    ...
                                    <a href="#">
                                        <button type="button" className="add_cart_btn ms-2 " data-bs-toggle="modal"
                                            data-bs-target="#inquiry_exampleModal" id="myBtn">Inquiry</button>
                                    </a>
                                            ...
                                            <div className="modal-content">
                                                <div className="row">
                                                    ...
                                                    <div className="modal-body" bis_skin_checked="1">
                                                        <div className="form-group col-md-6" bis_skin_checked="1">
                                                        ...
                                                        <div className="form-group col-md-6" bis_skin_checked="1">
                                                            ...
                                                            <textarea className="form-control" id="in_desc" name="in_desc"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div className="comp-wish d-flex align-items-center justify-content-start mt-4" bis_skin_checked="1">
                            ...
                            <div className="pt-4 pb-1" bis_skin_checked="1">
