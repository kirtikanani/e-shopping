                                    ...
                                    <div className=" col-lg-1 col-md-3 col-sm-3 col-2">
                                        <div className="shop_icon d-flex">
                                            ...
                                            <a href="#" className="ps-2">
                                                <i className="fas fa-list category_icon"></i>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="row pt-3">
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_8.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_9.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_10.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_11.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                            ...
                            <div className="row pt-3">
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_12.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_13.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_14.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
                                ...
                                <div className="col-lg-3 col-md-6 col-6">
                                    <div className="poroduct_item_block">
                                        <div className="product_img_block">
                                            <a href="#">
                                                <img src="./images/cloth_15.jpg" alt="Test Demo Product 3"/>
                                            </a>
                                            <span className="onsale">10% off</span>
                                        </div>
                                        <div className="product_details_block">
